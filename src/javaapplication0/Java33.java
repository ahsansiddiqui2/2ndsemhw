...
public class Java33 extends javax.swing.JFrame {
    ...
    private String Returner(){
        if(jCheckBox1.isEnabled()&&jCheckBox2.isEnabled()&&jCheckBox3.isEnabled()&&jCheckBox4.isEnabled()){
            Qualified = jCheckBox1.getText();
            Qualified1 = jCheckBox2.getText();
            Qualified2 = jCheckBox3.getText();
            Qualified3 = jCheckBox4.getText();
        }
        else if(jCheckBox1.isEnabled()&& jCheckBox2.isEnabled()&&jCheckBox3.isEnabled()){
            Qualified = jCheckBox1.getText();
            Qualified1 = jCheckBox2.getText();
            Qualified2 = jCheckBox3.getText();
            
        }
        else if(jCheckBox1.isEnabled()&&jCheckBox2.isEnabled()){
            Qualified = jCheckBox1.getText();
            Qualified1 = jCheckBox2.getText();
        }
